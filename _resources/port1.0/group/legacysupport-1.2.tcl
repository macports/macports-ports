...
#
# Note:  As of 2025 May 28, this version 1.2 is a drop-in
#   replacement for 1.1, except that specific C++ flags are added
#   to configure.cxxflags, rather than to configure.cppflags.
#
#   Discussion:  https://github.com/macports/macports-ports/pull/25895
#
#   Original CPP public symbols are preserved for backward compatibility:
#    * legacysupport::get_cpp_flags
#    * MACPORTS_LEGACY_SUPPORT_CPPFLAGS
#
#   New C++ public symbols:
#    * legacysupport::get_cxx_flags
#    * MACPORTS_LEGACY_SUPPORT_CXXFLAGS
#
#   New keyword options:  None
#
# Usage:
#
