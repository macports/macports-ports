...
proc php.add_port_code {} {
    ...
    platform darwin {
        if {[lsearch -exact ${phpknownfails} ${php.branch}] != -1} {
            known_fail          yes
            pre-fetch {
                ui_error "${php.branch} cannot currently be compiled due to libxml2 issues"
                return -code error "incompatible libxml2 support"
            }
        }
    }
