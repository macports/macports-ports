...
set portfetch::mirror_sites::sites(gentoo) {
    http://ftp-stud.hs-esslingen.de/pub/Mirrors/gentoo/:nosubdir
    http://ftp.daum.net/gentoo/:nosubdir
    http://ftp.dei.uc.pt/pub/linux/gentoo/:nosubdir
    http://ftp.fau.de/gentoo:nosubdir
    http://ftp.fi.muni.cz/pub/linux/gentoo/:nosubdir
    http://ftp.free.fr/mirrors/ftp.gentoo.org/:nosubdir
    http://ftp.halifax.rwth-aachen.de/gentoo/:nosubdir
    http://ftp.iij.ad.jp/pub/linux/gentoo/:nosubdir
    http://ftp.jaist.ac.jp/pub/Linux/Gentoo/:nosubdir
    http://ftp.kaist.ac.kr/pub/gentoo/:nosubdir
    http://ftp.lanet.kr/pub/gentoo/:nosubdir
    https://ftp.linux.org.tr/gentoo/:nosubdir
    http://ftp.ntua.gr/pub/linux/gentoo/:nosubdir
    http://ftp.rnl.tecnico.ulisboa.pt/pub/gentoo/gentoo-distfiles/:nosubdir
    http://ftp.romnet.org/gentoo/:nosubdir
    http://ftp.snt.utwente.nl/pub/os/linux/gentoo:nosubdir
    http://ftp.swin.edu.au/gentoo:nosubdir
    http://ftp.twaren.net/Linux/Gentoo/:nosubdir
    http://ftp.vectranet.pl/gentoo/:nosubdir
    http://gentoo-mirror.alexxy.name/:nosubdir
    http://gentoo.aditsu.net:8000/:nosubdir
    http://gentoo.bloodhost.ru/:nosubdir
    http://gentoo.c3sl.ufpr.br/:nosubdir
    http://gentoo.cs.utah.edu/:nosubdir
    http://gentoo.gossamerhost.com:nosubdir
    http://gentoo.mirror.web4u.cz/:nosubdir
    http://gentoo.mirrors.easynews.com/linux/gentoo/:nosubdir
    http://gentoo.mirrors.ovh.net/gentoo-distfiles/:nosubdir
    http://gentoo.mirrors.pair.com/:nosubdir
    http://gentoo.mirrors.tds.net/gentoo:nosubdir
    http://gentoo.mirrors.tera-byte.com/:nosubdir
    http://gentoo.modulix.net/gentoo/:nosubdir
    http://gentoo.osuosl.org/:nosubdir
    http://gentoo.ussg.indiana.edu/:nosubdir
    http://gentoo.wheel.sk/:nosubdir
    http://linux.rz.ruhr-uni-bochum.de/download/gentoo-mirror/:nosubdir
    http://mirror.bytemark.co.uk/gentoo/:nosubdir
    http://mirror.csclub.uwaterloo.ca/gentoo-distfiles/:nosubdir
    http://mirror.dkm.cz/gentoo/:nosubdir
    http://mirror.eu.oneandone.net/linux/distributions/gentoo/gentoo/:nosubdir
    http://mirror.isoc.org.il/pub/gentoo/:nosubdir
    http://mirror.leaseweb.com/gentoo/:nosubdir
    https://mirror.mdfnet.se/gentoo:nosubdir
    http://mirror.netcologne.de/gentoo/:nosubdir
    http://mirror.ps.kz/gentoo/pub:nosubdir
    http://mirror.rise.ph/gentoo:nosubdir
    http://mirror.sjc02.svwh.net/gentoo/:nosubdir
    http://mirror.yandex.ru/gentoo-distfiles/:nosubdir
    http://mirrors.163.com/gentoo/:nosubdir
    http://mirrors.evowise.com/gentoo/:nosubdir
    http://mirrors.rit.edu/gentoo/:nosubdir
    http://mirrors.soeasyto.com/distfiles.gentoo.org/:nosubdir
    https://mirrors.tuna.tsinghua.edu.cn/gentoo:nosubdir
    http://mirrors.xservers.ro/gentoo/:nosubdir
    http://tux.rainside.sk/gentoo/:nosubdir
    http://www.gtlib.gatech.edu/pub/gentoo:nosubdir
    http://www.mirrorservice.org/sites/distfiles.gentoo.org/:nosubdir
}
